...
namespace Database.Migrations
{
    ...
    [Migration("20250605093934_ReservationsHistory")]
    partial class ReservationsHistory
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Domain.MovableItems.Category", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Domain.MovableItems.MovableInstanceHistory", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("bigint")
            ...
            modelBuilder.Entity("Domain.MovableItems.Category", b =>
                {
                    b.HasOne("Domain.MovableItems.Category", "Parent")
                        .WithMany("Children")
            ...
            modelBuilder.Entity("Domain.MovableItems.MovableInstanceHistory", b =>
                {
                    b.HasOne("Domain.Locations.Location", "FromLocation")
                        .WithMany()
                        .HasForeignKey("FromLocationId")
                        .OnDelete(DeleteBehavior.Restrict)
                        .HasConstraintName("fk_movable_instance_history_locations_from_location_id");

                    b.HasOne("Domain.MovableItems.MovableInstance", "MovableInstance")
                        .WithMany("History")
                    ...
                    b.HasOne("Domain.Locations.Location", "ToLocation")
                        .WithMany()
            ...
            modelBuilder.Entity("Domain.MovableItems.MovableItem", b =>
                {
                    b.HasOne("Domain.MovableItems.Category", "Category")
