...
public interface IQueryService
{
    ...
    Task<PaginatedResponse<UserWithDetailsViewModel>> GetUsersWithDetailsAsync(PaginatedFilteredQuery<UserFiltersDto> query, CancellationToken cancellationToken = default);
}