...
{
    public Task<List<MovableInstanceViewModel>> GetAllFilteredAsync(uint itemId, MovableInstanceFiltersDto filters, CancellationToken ct = default)
    {
        ...
        return query
            .Select(instance => new MovableInstanceViewModel
            {
                Id = instance.Id,
                MovableItemId = instance.MovableItem.Id,
                Code = instance.Code,
                Status = instance.Status,
                Location = instance.Location == null ? null : new LocationViewModel
                {
                ...
                User = instance.User == null ? null : new UserViewModel
                {
                    Id = instance.User.Id,
    ...
    public Task<MovableInstanceViewModel?> GetByIdAsync(uint itemId, uint id, CancellationToken ct = default)
    {
