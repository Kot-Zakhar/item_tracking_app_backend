...
namespace ItTrAp.IdentityService.Application.Users.Commands;
...
public class ResetUserPasswordHandler(IUserService userService) : IRequestHandler<ResetUserPasswordCommand>
{
    ...
    {
        await userService.ResetPasswordAsync(request.Id, request.Passwords.NewPassword, cancellationToken);
    }
}